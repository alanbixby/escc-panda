...
class PandaSafety(Protocol):
  ...
  def get_escc_diag_car_to_radar_forwarded(self) -> int: ...
  def get_escc_diag_radar_to_car_forwarded(self) -> int: ...
  def get_escc_diag_scc_blocked_car_to_radar(self) -> int: ...
  def get_escc_diag_scc_blocked_radar_to_car(self) -> int: ...
  def get_escc_diag_queue_pressure_drops(self) -> int: ...
  def get_escc_diag_non_scc_car_to_radar_frames(self) -> int: ...
